...
- link codes and Drop codes are distinct, short-lived and single-use.

**Verification**

- concurrent one-time-code consumption;
...
| Complete Saturn | 0-13 | Full documented scope, DR and provider exit are verified |
