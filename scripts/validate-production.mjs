...
process.stdout.write(`${JSON.stringify({state:result.state,releaseVersion:result.releaseVersion,domain:result.domain,storageEnvironment:"production",laboratoryExposure:result.laboratoryExposure,rpoSeconds:result.rpoSeconds,rtoSeconds:result.rtoSeconds,secretFiles:result.secretFiles,immutableImages:result.immutableImages})}\n`);
