...
if (command === "build") {
  ...
  const compatible = { schema_version: 1, service: "saturn", version, image: { reference, digest }, web_image: webImage,
    compose_bundle: { url: bundleUrl, sha256: payload.bundle.sha256.slice(7) }, database_schema: payload.databaseSchemaGeneration, minimum_updater_version: pinnedUpdaterVersion, rollback_restore: "saturn-offline-v1" };
